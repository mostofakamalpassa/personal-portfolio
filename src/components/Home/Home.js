              ...
              <div className="container my-auto">
                <div className="row">
                  <div className="col-12 text-center">
                    ...
                    <TypeAnimation 
      cursor={true}
      sequence={["I'm Mostofa kamal", 2000, "I'm a Frontend Developer", 2000, "I'm a ReactJs Developer", 2000]}
      wrapper="h1" repeat={Infinity} 
    />
                    </div>
                    ...
                    <a
                      href="/assets/Resume_mostofa_kamal_.pdf" target="_blank"
